    ...
    public static void main(String[] args) {
        ...
        displayMenu();
    	   ...
    	   case '6':
    		   ...
    		   break;
    		 default:
    			 System.out.println("Session Closed with 'q'");
...
public static void displayMenu() {
    ...
    System.out.println("[3] Check reserved animals");
...
// Checks if monkey is already in the system
    ...
    public static void intakeNewMonkey(Scanner scanner) {
        ...
        boolean reserved = scanner.nextLine() != null;
        ...
        Monkey monkey = new Monkey(name, gender, age, weight,acquisitionDate,acquisitionCountry,trainingStatus,height,inServiceCountry,species,tailLength,reserved, bodyLength);
